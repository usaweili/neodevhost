...
```
Total ad / tracking block list 屏蔽追踪广告总数: 116814

Total allowlist list 允许名单总数: 1460

Total combine list 结合总数： 116679

Total deadblock list 失效屏蔽广告域名： 34856

Total deadallow list 失效允许广告域名： 108

Update 更新时间: 2020-08-25
```
### UPTODATE 保持最新<br/>
