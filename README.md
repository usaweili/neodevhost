...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115605

Total allowlist list 允许名单总数: 1461

Total combine list 结合总数： 115472

Total deadblock list 失效屏蔽广告域名： 35140

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2020-09-02
```
### UPTODATE 保持最新<br/>
