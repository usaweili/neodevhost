...
```
Total ad / tracking block list 屏蔽追踪广告总数: 106935

Total allowlist list 允许名单总数: 1465

Total combine list 结合总数： 106809

Total deadblock list 失效屏蔽广告域名： 24977

Total deadallow list 失效允许广告域名： 110

Update 更新时间: 2020-09-11
```
### UPTODATE 保持最新<br/>
