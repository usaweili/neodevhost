...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115420

Total allowlist list 允许名单总数: 1467

Total combine list 结合总数： 115286

Total deadblock list 失效屏蔽广告域名： 35155

Total deadallow list 失效允许广告域名： 102

Update 更新时间: 2020-08-27
```
### UPTODATE 保持最新<br/>
