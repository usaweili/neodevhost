...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115453

Total allowlist list 允许名单总数: 1461

Total combine list 结合总数： 115318

Total deadblock list 失效屏蔽广告域名： 35930

Total deadallow list 失效允许广告域名： 108

Update 更新时间: 2020-08-29
```
### UPTODATE 保持最新<br/>
