...
```
Total ad / tracking block list 屏蔽追踪广告总数: 1067719

Total allowlist list 允许名单总数: 2264

Total combine list 结合总数： 1067477

Total deadblock list 失效屏蔽广告域名： 47900

Total deadallow list 失效允许广告域名： 93

Update 更新时间: 2020-10-17
```
### UPTODATE 保持最新<br/>
