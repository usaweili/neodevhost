...
```
Total ad / tracking block list 屏蔽追踪广告总数: 215571

Total allowlist list 允许名单总数: 1252

Total combine list 结合总数： 215427

Total deadblock list 失效屏蔽广告域名： 47358

Total deadallow list 失效允许广告域名： 85
