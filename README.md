...
```
Total ad / tracking block list 屏蔽追踪广告总数: 148139

Total allowlist list 允许名单总数: 1248

Total combine list 结合总数： 148008

Total deadblock list 失效屏蔽广告域名： 33676

Total deadallow list 失效允许广告域名： 89

Update 更新时间: 2020-10-16
```
### UPTODATE 保持最新<br/>
