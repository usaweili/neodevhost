...
```
Total ad / tracking block list 屏蔽追踪广告总数: 116834

Total allowlist list 允许名单总数: 1450

Total combine list 结合总数： 116703

Total deadblock list 失效屏蔽广告域名： 34971

Total deadallow list 失效允许广告域名： 118
