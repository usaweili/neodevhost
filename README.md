...
```
Total ad / tracking block list 屏蔽追踪广告总数: 118277

Total allowlist list 允许名单总数: 1460

Total combine list 结合总数： 118143

Total deadblock list 失效屏蔽广告域名： 35645

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2020-08-17
```
### UPTODATE 保持最新<br/>
