...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115430

Total allowlist list 允许名单总数: 1390

Total combine list 结合总数： 115300

Total deadblock list 失效屏蔽广告域名： 35438

Total deadallow list 失效允许广告域名： 179

Update 更新时间: 2020-08-28
```
### UPTODATE 保持最新<br/>
