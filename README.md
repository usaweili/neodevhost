...
```
Total ad / tracking block list 屏蔽追踪广告总数: 95780

Total allowlist list 允许名单总数: 1252

Total combine list 结合总数： 95671

Total deadblock list 失效屏蔽广告域名： 17381

Total deadallow list 失效允许广告域名： 85

Update 更新时间: 2020-10-20
```
### UPTODATE 保持最新<br/>
