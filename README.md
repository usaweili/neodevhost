...
```
Total ad / tracking block list 屏蔽追踪广告总数: 148239

Total allowlist list 允许名单总数: 2142

Total combine list 结合总数： 148065

Total deadblock list 失效屏蔽广告域名： 47900

Total deadallow list 失效允许广告域名： 215
