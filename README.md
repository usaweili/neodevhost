...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115384

Total allowlist list 允许名单总数: 1448

Total combine list 结合总数： 115256

Total deadblock list 失效屏蔽广告域名： 35392

Total deadallow list 失效允许广告域名： 120

Update 更新时间: 2020-08-26
```
### UPTODATE 保持最新<br/>
