...
```
Total ad / tracking block list 屏蔽追踪广告总数: 106374

Total allowlist list 允许名单总数: 1457

Total combine list 结合总数： 106253

Total deadblock list 失效屏蔽广告域名： 24501

Total deadallow list 失效允许广告域名： 113

Update 更新时间: 2020-09-07
```
### UPTODATE 保持最新<br/>
