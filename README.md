...
```
Total ad / tracking block list 屏蔽追踪广告总数: 97110

Total allowlist list 允许名单总数: 1476

Total combine list 结合总数： 96986

Total deadblock list 失效屏蔽广告域名： 19467

Total deadallow list 失效允许广告域名： 101

Update 更新时间: 2020-10-03
```
### UPTODATE 保持最新<br/>
